    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white">
            ...
            <div class="p-6 border-b border-gray-200">
                <h3 class="bg-green-200 p-2 font-medium mb-4">Basic Information</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-[0.6rem] border border-gray-300 rounded-md">
                ...
                <div class="mb-6">
                    <label class="flex items-start">
                        ...
                        <span class="text-sm text-gray-700">
                            I agree <a href="#" class="text-blue-600 hover:underline">terms and conditions</a>
                        </span>
                    </label>
                </div>
