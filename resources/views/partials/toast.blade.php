            ...
            window.customToastHTML = `
                <div class='relative flex items-start justify-center p-4'>
                    ...
                    <div class='flex flex-col'>
                        ...
                        <div class='flex mt-3'>
                            <button type='button' @click='burnToast(toast.id)' class='inline-flex items-center px-2 py-1 text-xs font-semibold text-white bg-indigo-600 rounded shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>Accept</button>
